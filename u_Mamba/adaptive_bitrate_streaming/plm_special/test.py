...
from baseline_special.utils.constants import (
    ...
    M_IN_K, SMOOTH_PENALTY, VIDEO_BIT_RATE, HD_REWARD,CHUNK_TIL_VIDEO_END_CAP, MAX_VIDEO_BIT_RATE, DEFAULT_QUALITY
)
...
def test_on_env(args, model, results_dir, env_settings, target_return, max_ep_num=100, process_reward_fn=None, seed=0):
    ...
    with torch.no_grad():
        ...
        with tqdm.tqdm(total=max_ep_num, desc='[Testing]', unit='ep') as pbar:
            while True:
