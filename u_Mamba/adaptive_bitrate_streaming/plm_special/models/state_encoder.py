...
from baseline_special.utils.constants import S_LEN ,BITRATE_DIM
...
class EncoderNetwork(nn.Module):
    ...
    """
    def __init__(self, conv_size=4, bitrate_levels=BITRATE_DIM, embed_dim=128):
        super().__init__()
    ...
    def forward(self, state):
        ...
        state = state.reshape(batch_size * seq_len, 6, S_LEN )
