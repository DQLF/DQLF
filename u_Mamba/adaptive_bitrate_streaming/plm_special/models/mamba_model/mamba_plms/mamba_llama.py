...
from baseline_special.utils.constants import BITRATE_DIM
...
class MambaLlamaNetworkingHeadModel(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.mamba_embed_size = config.mamba_embed_size  # 假设 Mamba 的 hidden_size 就是 PLM 的 embedding size
        self.bitrate_levels = BITRATE_DIM
        ...
        # self.networking_head = nn.Linear(self.mamba_embed_size, self.bitrate_levels)
