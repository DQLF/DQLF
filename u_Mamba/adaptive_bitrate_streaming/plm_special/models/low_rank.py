...
def print_trainable_parameters(model):
    ...
    print(
        f"Teacher llama Model trainable params: {trainable_params} || all params: {all_param} || trainable%: {100 * trainable_params / all_param}"
    )


def peft_model(plm, plm_type, rank, print_trainable=True, task_type=TaskType.FEATURE_EXTRACTION):
