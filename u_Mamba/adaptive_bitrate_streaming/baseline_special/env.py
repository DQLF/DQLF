...
from baseline_special.utils.constants import BITRATE_LEVELS,VIDEO_BIT_RATE,TOTAL_VIDEO_CHUNK,VIDEO_CHUNK_LEN
...
class Environment:
    def __init__(self, all_cooked_time, all_cooked_bw, all_file_names=None, all_mahimahi_ptrs=None, 
                 video_size_dir=None, fixed=False, trace_num=100, training=True,**kwargs):
